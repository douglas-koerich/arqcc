...
section .text
    global main
    ;extern printf (NAO SAO USADAS NO SASM!)
    ;extern scanf
...
sentido:
    ...
    je      print_anti
    ;push    str_horario
    PRINT_STRING str_horario
    jmp     print_sentido
print_anti:
    ;push    str_antihor
    PRINT_STRING str_antihor
print_sentido:
    ;call    printf
    ;add     esp, 4
    ...
    PRINT_STRING str_reduzido
    PRINT_DEC 2, reduzido
    NEWLINE
