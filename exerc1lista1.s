...
main:   ; equivale ao ponto de entrada da funcao main() num programa em C
    ...
    push    dword [sec] ; fazer push [seg] nao especificaria quantos bytes se-..
    push    dword [min] ; ..-rao empilhados; dword indica para push que deve..
    push    dword [hora]; .. pegar 4 bytes a partir do endereco dado pelo rotulo
    push    msg_final
    call    printf
    add     esp, 16
